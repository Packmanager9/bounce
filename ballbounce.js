...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    function setUp(canvas_pass, style = "#000000") {
        ...
        function continued_stimuli(e) {
            ...
            paddle1.ymom = (paddle1.y - (TIP_engine.y - (paddle1.height * .5))) * -1
            paddle2.xmom = (paddle2.x - (TIP_engine.x - (paddle2.width * .5))) * -1
            paddle3.ymom = (paddle3.y - (TIP_engine.y - (paddle3.height * .5))) * -1
            paddle4.xmom = (paddle4.x - (TIP_engine.x - (paddle4.width * .5))) * -1
            paddle1.y = TIP_engine.y - (paddle1.height * .5)
            paddle3.y = TIP_engine.y - (paddle3.height * .5)
            paddle2.x = TIP_engine.x - (paddle2.width * .5)
            paddle4.x = TIP_engine.x - (paddle4.width * .5)
            if (paddle1.x < 0) {
                paddle1.x = 0
                paddle1.xmom = 0
            }
            ...
            if (paddle3.x + paddle3.width > canvas.width) {
                paddle3.x = canvas.width - paddle3.width
                paddle3.xmom = 0
            }
            if (paddle3.y + paddle3.height > canvas.height) {
                paddle3.y = canvas.height - paddle3.height
                paddle3.ymom = 0
            }

            if (paddle4.x + paddle4.width > canvas.width) {
                paddle4.x = canvas.width - paddle4.width
                paddle4.xmom = 0
            }
            if (paddle4.y + paddle4.height > canvas.height) {
    ...
    let paddle1 = new Rectangle(0, 0, 20, 500, "yellow")
    let paddle2 = new Rectangle(0, 0, 200, 20, "#00FF00")
    let paddle3 = new Rectangle(680, 0, 20, 300, "blue")
    let paddle4 = new Rectangle(0, 680, 250, 20, "red")
    ...
    function main() {
        ...
        for (let s = 0; s < balls.length; s++) {
            if (paddle1.doesPerimeterTouch(balls[s])) {
                if (balls[s].xmom < 0) {
                    balls[s].xmom *= -1
            ...
            if (paddle2.doesPerimeterTouch(balls[s])) {
                if (balls[s].ymom < 0) {
                    balls[s].ymom *= -1
            ...
            if (paddle3.doesPerimeterTouch(balls[s])) {
                if (balls[s].xmom > 0) {
                    balls[s].xmom *= -1
            ...
            if (paddle4.doesPerimeterTouch(balls[s])) {
                if (balls[s].ymom > 0) {
                    balls[s].ymom *= -1
